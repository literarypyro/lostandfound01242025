...
var registrationModule=angular.module("registrationApp",["$scope",'$http']);
registrationModule.controller("registrationController",['$scope',"$http", function registrationController($scope,$http){
